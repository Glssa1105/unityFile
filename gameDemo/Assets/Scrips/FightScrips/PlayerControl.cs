...
public class PlayerControl : MonoBehaviour
{
    ...
    [SerializeField]public GameMessage gameMessage;
    ...
    //以下为玩家属性
        ...
        public int skill_1_SkillStatu;//表示 1 技能伤害属性
        public int skill_1_value;//表示 1 数值 根据技能种类含不同意义
        public string skill_1_Detail;
        ...
        public int skill_2_SkillStatu;//表示 2 技能伤害属性
        public int skill_2_value;//表示 2 数值 根据技能种类含不同意义
        public string skill_2_Detail;
    ...
    void Start()
    {
        ...
        if(GameObject.Find("GameMessage"))
        Debug.Log(1);
        if(GameManager.TEST)
        {
            switch(playerNumber)
            {
                    case 1:
                        blood = gameMessage.Player_1_Hp;
                        Mp = gameMessage.Player_1_Mp;
                        maxBlood = gameMessage.Player_1_MaxHp;
                        MaxMP = gameMessage.Player_1_MaxMp;
                        break;
                    case 2:
                        blood = gameMessage.Player_2_Hp;
                        Mp = gameMessage.Player_2_Mp;
                        maxBlood = gameMessage.Player_2_MaxHp;
                        MaxMP = gameMessage.Player_2_MaxMp;
                        break;
                    case 3:
                        blood = gameMessage.Player_3_Hp;
                        Mp = gameMessage.Player_3_Mp;
                        maxBlood = gameMessage.Player_3_MaxHp;
                        MaxMP = gameMessage.Player_3_MaxMp;
                        break;
                    case 4:
                        blood = gameMessage.Player_4_Hp;
                        Mp = gameMessage.Player_4_Mp;
                        maxBlood = gameMessage.Player_4_MaxHp;
                        MaxMP = gameMessage.Player_4_MaxMp;
                        break;
            }
        }
    }
